...
import { faEnvelope, faHome, faSuitcase, faUser, faBars, faClose, faFile} from '@fortawesome/free-solid-svg-icons'
import { faGithub, faLinkedin } from '@fortawesome/free-brands-svg-icons'
import  VLResume from '../../assets/Victoria Le - Resume - GA.pdf'
    ...
    return (
        <div className='nav-bar'>
            ...
            <ul>
                ...
                <li>
                    <a target='_blank' rel='noopener noreferrer' href={VLResume}>
